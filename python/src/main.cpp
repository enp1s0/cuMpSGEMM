...
void set_exp_stats_params(
	...
	cumpsgemm::hijack_control::set_exp_stats_params(ignore_threshold, underflow_threshold, underflow_tolerance_rate);
}
...
void set_global_cublas_dim_mn_threshold(const unsigned dim) {global_cublas_dim_mn_threshold = dim;}
unsigned get_global_cublas_dim_mn_threshold() {return global_cublas_dim_mn_threshold;}
void set_global_cublas_dim_k_threshold(const unsigned dim) {global_cublas_dim_k_threshold = dim;}
unsigned get_global_cublas_dim_k_threshold() {return global_cublas_dim_k_threshold;}
